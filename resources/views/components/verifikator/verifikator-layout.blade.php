...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="/vendors/adminlte3/plugins/summernote/summernote-bs4.min.css">
</head>
...
<body class="hold-transition sidebar-mini sidebar-collapse">
    ...
    <div class="wrapper">
        ...
        <x-verifikator.verifikator-sidebar></x-verifikator.verifikator-sidebar>
        <x-verifikator.verifikator-navbar></x-verifikator.verifikator-navbar>
    ...
    <!-- Summernote -->
    <script src="/vendors/adminlte3/plugins/summernote/summernote-bs4.min.js"></script>

    <!-- My Script -->
    <script src="/assets/script/verifikatorScript.js"></script>
</body>
